...
# Name:         block_area
#
# Descirption:  compute the area of the block figure
#
...
# Name:         block_diameter
#
# Description:  Computer the diameter of the block figure
#
# Arguments:    a0 contains the address if the figure object
#
